...
class AssetCategory(SolichModel):
    """
...
class Asset(SolichModel):
    ...
    objects = SolichCompanyManager("asset_category_id__company_id")
...
class AssetDocuments(SolichModel):
    """
...
class ReturnImages(SolichModel):
    """
...
class AssetAssignment(SolichModel):
    """
    ...
    objects = SolichCompanyManager("asset_id__asset_lot_number_id__company_id")
...
class AssetRequest(SolichModel):
    """
