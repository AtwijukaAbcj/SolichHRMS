...
class EmployeeObjective(SolichModel):
    ...
    history = SolichAuditLog(bases=[SolichAuditInfo], related_name="history_set")
    archive = models.BooleanField(default=False)
...
class Comment(models.Model):
    ...
    history = SolichAuditLog(excluded_fields=["comment"], bases=[SolichAuditInfo])
    objects = SolichCompanyManager(
...
class QuestionTemplate(SolichModel):
...
class Question(SolichModel):
    ...
    objects = SolichCompanyManager("template_id__company_id")

    def __str__(self):
        return self.question


class QuestionOptions(SolichModel):
    ...
    objects = SolichCompanyManager("question_id__template_id__company_id")


class Feedback(SolichModel):
