...
class OnboardingStage(SolichModel):
    """
    ...
    objects = SolichCompanyManager("recruitment_id__company_id")
...
class OnboardingTask(SolichModel):
    """
    ...
    objects = SolichCompanyManager("stage_id__recruitment_id__company_id")

    def __str__(self):
        return f"{self.task_title}"


class CandidateStage(SolichModel):
    """
    ...
    objects = SolichCompanyManager("candidate_id__recruitment_id__company_id")
...
class CandidateTask(SolichModel):
    """
    CandidateTask model
    """
...
class OnboardingPortal(SolichModel):
    """
