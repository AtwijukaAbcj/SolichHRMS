...
from solich_views import models
from solich_views.cbv_methods import (
    get_short_uuid,
    paginator_qry,
    sortby,
    structured,
...
from solich_views.forms import ToggleColumnForm
...
class SolichListView(ListView):
    ...
    template_name: str = "generic/Solich_list.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        update_initial_cache(request, cache, SolichListView)
    ...
    def get_context_data(self, **kwargs: Any):
        ...
        cache[self.request.session.session_key][SolichListView] = context
        from solich.urls import path, urlpatterns
    ...
    def export_data(self, *args, **kwargs):
        ...
        class SolichListViewResorce(resources.ModelResource):
        ...
        book_resource = SolichListViewResorce()
...
class SolichSectionView(TemplateView):
    """
    Solich Template View
    """
    ...
    template_name = "generic/Solich_section.html"
...
class SolichDetailedView(DetailView):
    """
    SolichDetailedView
    """

    title = "Detailed View"
    template_name = "generic/Solich_detailed_view.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, cache, SolichDetailedView)
    ...
    def get_context_data(self, **kwargs: Any):
        ...
        cache[self.request.session.session_key][SolichDetailedView] = context

        return context


class SolichTabView(TemplateView):
    """
    SolichTabView
    """

    template_name = "generic/Solich_tabs.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, cache, SolichTabView)
    ...
    def get_context_data(self, **kwargs):
        ...
        cache[self.request.session.session_key][SolichTabView] = context

        return context


class SolichCardView(ListView):
    """
    SolichCardView
    """
    ...
    template_name = "generic/Solich_card.html"
    context_object_name = "queryset"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, cache, SolichCardView)
    ...
    def get_context_data(self, **kwargs):
        ...
        cache[self.request.session.session_key][SolichCardView] = context
        return context
...
class SolichFormView(FormView):
    ...
    template_name = "generic/Solich_form.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, cache, SolichFormView)
    ...
    def get_form(self, form_class=None):
        ...
        cache[self.request.session.session_key][SolichFormView] = form
        self.form = form
        return form


class SolichNavView(TemplateView):
    """
    SolichNavView
    ...
    template_name = "generic/Solich_nav.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, cache, SolichNavView)
    ...
    def get_context_data(self, **kwargs):
        ...
        cache[self.request.session.session_key][SolichNavView] = context
        return context
